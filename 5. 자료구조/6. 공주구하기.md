...
- 정답
    ...
    public class Main {
    	...
    	public int solution(int len, int out) {
    		int answer = 0;
    	...
    	public static void main(String[] args) {
    		...
    		System.out.println(main.solution(len, out));
...
- 도전_실패(0526)
    ...
    //		String str = scan.next();
    		...
    		System.out.println(main.solution(p, c));
